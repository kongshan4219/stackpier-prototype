...
function notifyDependencies(p,o){
 if(o.status!=='success'||!['deploy','apply','update','restore'].includes(o.kind)||o.dependencyNotificationChecked||!Object.prototype.hasOwnProperty.call(o.input,'applied')||!p.applied)return;
